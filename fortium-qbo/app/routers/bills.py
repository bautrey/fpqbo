...
async def list_bills(
    ...
    """List bills, optionally filtered by date range.

    The ledger holds far more bills than QuickBooks will return for a single
    query, so this is one page of a result set. Page with `offset`, and read
